...
def deploy(environment):
    ...
    if environment == "production":
        tags += [
            'dns_vpn_internal_network_route53',     # Enable Route53 DNS for internal VPN client addreses
            'dns_vpn_server_route53',               # Enable Route53 DNS for connecting to the server
        ]
    elif environment == "testing":
        # Testing environment varsfiles have some variables that override prod varsfiles
        # Be careful - order is important when overriding variables in Ansible
        varsfiles += [
